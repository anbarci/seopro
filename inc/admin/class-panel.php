		...
		return [
			...
			'icerik'     => [
				...
				'fields' => [
					...
					'seopro_tabposts_style'  => [ 'type' => 'select', 'label' => __( 'Sekmeli yazılar görünümü', 'seopro' ), 'choices' => [ 'cards' => __( 'Resimli', 'seopro' ), 'list' => __( 'Sade liste (önceki tasarım, resimsiz)', 'seopro' ) ], 'desc' => __( 'Sidebar "Sekmeli Yazılar" widget\'ının görünümü. Sade liste, üç sekme açıkken de kullanılabilir.', 'seopro' ) ],
